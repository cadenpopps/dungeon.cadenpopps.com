...
"use strict";var _createClass=function(){function defineProperties(target,props){for(var i=0;i<props.length;i++){var descriptor=props[i];descriptor.enumerable=descriptor.enumerable||false;descriptor.configurable=true;if("value"in descriptor)descriptor.writable=true;Object.defineProperty(target,descriptor.key,descriptor)}}return function(Constructor,protoProps,staticProps){if(protoProps)defineProperties(Constructor.prototype,protoProps);if(staticProps)defineProperties(Constructor,staticProps);return Constructor}}();function _classCallCheck(instance,Constructor){if(!(instance instanceof Constructor)){throw new TypeError("Cannot call a class as a function")}}function _possibleConstructorReturn(self,call){if(!self){throw new ReferenceError("this hasn't been initialised - super() hasn't been called")}return call&&(typeof call==="object"||typeof call==="function")?call:self}function _inherits(subClass,superClass){if(typeof superClass!=="function"&&superClass!==null){throw new TypeError("Super expression must either be null or a function, not "+typeof superClass)}subClass.prototype=Object.create(superClass&&superClass.prototype,{constructor:{value:subClass,enumerable:false,writable:true,configurable:true}});if(superClass)Object.setPrototypeOf?Object.setPrototypeOf(subClass,superClass):subClass.__proto__=superClass}var ActionSystem=function(_System){_inherits(ActionSystem,_System);function ActionSystem(){_classCallCheck(this,ActionSystem);var _this=_possibleConstructorReturn(this,(ActionSystem.__proto__||Object.getPrototypeOf(ActionSystem)).call(this,[component_actions]));_this.hitstunTimer=0;return _this}_createClass(ActionSystem,[{key:"run",value:function run(engine){if(this.hitstunTimer==0){var _iteratorNormalCompletion=true;var _didIteratorError=false;var _iteratorError=undefined;try{for(var _iterator=this.objects[Symbol.iterator](),_step;!(_iteratorNormalCompletion=(_step=_iterator.next()).done);_iteratorNormalCompletion=true){var entity=_step.value;if(entity.actions.busy>0){entity.actions.busy-=entity.actions.speed}else{this.setCurrentAction(entity,engine)}}}catch(err){_didIteratorError=true;_iteratorError=err}finally{try{if(!_iteratorNormalCompletion&&_iterator.return){_iterator.return()}}finally{if(_didIteratorError){throw _iteratorError}}}}else{this.hitstunTimer--}}},{key:"handleEvent",value:function handleEvent(engine,eventID,data){switch(eventID){case event_successful_action:this.handleSuccessfulAction(engine,data.entity,data.action);break;case event_failed_action:this.handleFailedAction(engine,data.entity);break;case event_hitstun:this.hitstunTimer=data.ticks;break;}}},{key:"setCurrentAction",value:function setCurrentAction(entity,engine){entity.actions.currentAction=entity.actions.nextAction;entity.actions.nextAction=action_none}},{key:"handleSuccessfulAction",value:function handleSuccessfulAction(engine,entity,action){entity.actions.busy=action_to_length[action];if(entity.components.includes(component_sprint)&&Utility.isMovementAction(action)){this.handleSprinting(entity,engine)}entity.animation.animation=action_to_animation[action];engine.sendEvent(event_new_animation,entity);entity.actions.lastAction=action;entity.actions.currentAction=action_none}},{key:"handleFailedAction",value:function handleFailedAction(engine,entity){entity.actions.busy=3;entity.actions.lastActionFailed=true;entity.actions.lastAction=entity.actions.currentAction;entity.actions.currentAction=action_none}},{key:"handleSprinting",value:function handleSprinting(entity,engine){if(entity.sprint.sprinting){entity.actions.busy=action_to_length[action_sprint]}}}]);return ActionSystem}(System);
