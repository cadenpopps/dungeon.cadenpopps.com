...
function loadImages(){
	...
	images.textures[texture_floor][texture_alt2] = loadImage('/img/textures/old/pathTexture0.png');
	images.textures[texture_floor][texture_alt3] = loadImage('/img/textures/old/pathTexture1.png');
	images.textures[texture_floor][texture_alt4] = loadImage('/img/textures/old/pathTexture2.png');
	images.textures[texture_floor][texture_alt5] = loadImage('/img/textures/old/pathTexture3.png');
	images.textures[texture_floor][texture_alt6] = loadImage('/img/textures/old/pathTexture4.png');
	...
	images.textures[texture_wall][texture_default] = loadImage('/img/textures/old/wallTexture0.png');
	...
	images.textures[texture_wall][texture_num_alts] = 6;

	images.textures[texture_wall][texture_corner_top_right] = loadImage('/img/textures/corner_top_right.png');
	images.textures[texture_wall][texture_corner_top_left] = loadImage('/img/textures/corner_top_left.png');
	images.textures[texture_wall][texture_corner_bottom_right] = loadImage('/img/textures/corner_bottom_right.png');
	images.textures[texture_wall][texture_corner_bottom_left] = loadImage('/img/textures/corner_bottom_left.png');
