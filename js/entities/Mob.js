...
function Mob(x, y, depth, config, actions, animations) {
	Entity.call(this, x, y, depth, config.health + depth, config.strength + depth, config.dexterity + depth, config.intelligence + depth, config.size, config.speed, actions, animations);
