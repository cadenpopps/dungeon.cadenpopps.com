...
function Player(x, y, config, playerClass, actions, animations) {
	...
	this.components.push(component_direction, component_health, component_combat, component_actions, component_collision, component_sprint, component_light_emitter);
