const ACTION_FAIL = 0, ACTION_SUCCESS = 1, ACTION_STAIR_DOWN = 2, ACTION_STAIR_UP = 3, ACTION_ATTACK = 4;
const SLOW_ACTION = 0, NORMAL_ACTION = 1, FAST_ACTION = 2, IMMEDIATE_ACTION = 3;

function InputManager(dungeon, player){
