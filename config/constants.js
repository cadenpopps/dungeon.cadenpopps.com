//Commands
const command_move_entity = 0, command_roll_entity = 1, command_generate_level = 2, command_generate_player = 3;
...
//Actions
const action_none = -1, action_move = 0, action_move_up = 1, action_move_right = 2, action_move_down = 3, action_move_left = 4, action_move_sprint = 5, action_foward_attack = 6, action_spin_attack = 7, action_roll = 8, action_failed_roll = 9; 
